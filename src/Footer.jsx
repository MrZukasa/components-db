    ...
    return (
        <footer>            
            <div class="py-6 px-4 dark:bg-slate-800 bg-gray-200 border-t dark:border-gray-600 border-gray-900 flex justify-between transition duration-200">
                <div class="flex">
                    <a href="https://github.com/MrZukasa/components-db" class="text-gray-400 dark:hover:text-white hover:text-black mr-2">
                ...
                <div class="mr-8">
                    {colorTheme == 'light' ? (
                    <button class="scale-150" onClick={() =>setColorTheme(colorTheme)}>🌤️</button> ) : (
                    <button class="scale-150" onClick={() =>setColorTheme(colorTheme)}>🌙</button>)}
                </div>
            </div>
        </footer>
    );
